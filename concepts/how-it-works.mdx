...
| Timing, ordering, and the agent's name | Your prompts, outputs, or documents |
...
one unrecoverable state in the system. See [Keep what you anchored](/guides/log-store).
