...
The limits are specified in
[`evidence-bundle.md` §5.3.4](https://github.com/sanning-io/proof/blob/main/specs/evidence-bundle.md),
which is the normative source. This page is the plain reading.
