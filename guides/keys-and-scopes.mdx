...
a password and an organization name. No card.

In the console, open **Settings, API keys** and select **Create key**. Name
...
If the retiring key is genuinely lost, an owner or admin re-keys the agent
from **Settings, Signing keys** in the console instead.
