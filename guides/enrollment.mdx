...
- **A key already enrolled under another name is refused.** Registering it
  ...
  retired or revoked under that other name, in your organization or another.
  The error names no organization.
- **A revoked key is refused everywhere, permanently.** Revocation repudiates
  ...
  (409) from the SDK lane. A key stays reserved even if the organization that
  enrolled it is later deleted.
